...
namespace SalesWebMvc.Data
{
    ...
    {
        //injecção de dependência via context - Isto serve para lançar dados para a base de dados via DbContext
        ...
        public void Seed()
        {
            ...
            //forma de adicionar os dados para a base de dados via Seeding
            ...
            _context.SaveChanges();//Gravar na Base de dados
        }
    }
}
